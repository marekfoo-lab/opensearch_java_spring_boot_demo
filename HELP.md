...
* The original package name 'pl.mfc.java.demo.opensearch.demo-opensearch' is invalid and this project uses 'pl.mfc.java.demo.opensearch.demo_opensearch' instead.
